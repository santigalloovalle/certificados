        ...
        <div class="col-md-6 align-self-center">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" style="visibility: visible;">
            <g>
              ...
              <g id="planet" style="transform-origin: 0px 0px;" transform="matrix(0.9995,-0.0301,0.0301,0.9995,-2.991,17.1499)">
                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

                <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,2.59,0)"></circle>

                <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,-2.59,0)"></circle>
              ...
              <g id="stars">
                <g id="starsBig">
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.9963,0.086,-0.086,0.9963,23.931,-43.6069)">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.9999,0.0157,-0.0157,0.9999,3.8148,-2.4022)">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.9976,-0.0698,0.0698,0.9976,-9.2374,22.6894)">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.9954,-0.0959,0.0959,0.9954,-46.424,21.5154)">
                ...
                <g id="starsSmall">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.993,0,0,0.9933,1.7082,3.6965)">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.92,0,0,0.9205,14.9087,32.6861)">
                  ...
                  <g style="transform-origin: 0px 0px;" transform="matrix(0.767,0,0,0.7677,111.9091,95.5093)">
                ...
                <g id="circlesBig">
                  ...
                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" style="transform-…
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
      <div class="row">
            ...
            <g>
              ...
              <g id="stars">
                ...
                <g id="circlesBig">
                  ...
                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-1.726)"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-1.726)" style="transform-origin: 0px 0px;"></circle>
                </g>
                <g id="circlesSmall">
                  <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                  <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,0,-3.453)"></circle>
                </g>
              </g>
              <g id="spaceman" clip-path="url(cordClip)" style="transform-origin: 0px 0px;" transform="matrix(0.9999,0.0151,-0.0151,0.9999,3.3317,1.2428)">
              ...
              C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
                ...
                <g id="head">
                  ...
                  M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" style="transform-origin: 0px 0px;" transform="matrix(0.9999,0.0151,-0.0151,0.9999,3.9771,-4.2098)"></path>
        ...
        <div class="col-md-6 align-self-center">
          <h1>423</h1>
          <h2>UH OH! Error!!.</h2>
          <p>Ocurrio un error, por favor vuelve a intentar...
          </p>
